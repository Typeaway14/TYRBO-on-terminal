tyrbo.exe: type_content.o client.o tc.o type_structures.o
	gcc -g resources/bin/client.o resources/bin/type_content.o resources/bin/type_structures.o resources/bin/tc.o -o tyrbo
